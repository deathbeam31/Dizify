...
def page_html(it, kind, genres):
    ...
    desc = f"{title} ({year}) {', '.join(gnames[:2]) or 'yapım'} {tur} — konusu, TMDB puanı ({rating}), fragmanı ve Türkiye'de nerede izleneceği FilmArşivi'nde."
...
<title>{esc(title)} ({year}) — Konusu, Puanı, Nerede İzlenir? | FilmArşivi</title>
<meta name="description" content="{esc(desc[:158])}">
<link rel="canonical" href="{canon}">
<meta property="og:title" content="{esc(title)} ({year}) | FilmArşivi">
...
<p class="ov">{esc(ov)}</p>
<a class="cta" href="../index.html">▶ FilmArşivi'nde Keşfet — fragman ve izleme platformları</a>
</div>
</div>
</main>
<footer>© FilmArşivi · <a href="../index.html">Ana Sayfa</a> · <a href="../arsiv.html">Arşiv</a><br>
Veriler TMDB API'sinden alınmıştır; bu site TMDB tarafından onaylanmamıştır.</footer>
</body>
</html>"""
