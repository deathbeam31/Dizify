...
def providers_block(title, year, is_tv, prov):
    ...
    return f'<section class="providers"><h2>Nerede İzlenir?</h2>{intro}{body}' \
           f'<p class="pv-src">İzleme verisi JustWatch üzerinden TMDB API\'si ile sağlanır ve düzenli güncellenir.</p></section>'
...
Veriler TMDB API'sinden alınmıştır; bu site TMDB tarafından onaylanmamıştır. İzleme verisi: JustWatch.</footer>
</body>
</html>"""
